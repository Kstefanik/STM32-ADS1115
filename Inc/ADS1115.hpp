 ...
 * So you should be able to extern the library support to other STM32 mcus by
...
namespace ks
{
     ...
     * For ways of setting them refer to ADS1115 datasheet
     */
    enum ADDR
    {
        ADDR_0x48 = 0x48,
    ...
    /**
     * Enums defining avaiable configuration options
     */
    ...
    public:
         ...
         * Sets the configuation bits as default stated in ADS1115 datasheet:
        ...
        /**
         * Returns the value currently stored in conversion register
         */
